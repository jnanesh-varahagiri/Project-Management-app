...
export default function NewProject({onSave,onCancel}) {
  ...
  return (
    ...
    <Modal ref={modal} buttonCaption="Close">
        ...
        <p className='text-stone-900 mb-4'>Please make sure you provide a valid value for every input field.</p>
    </Modal>
    ...
    <div className="w-[35rem] mt-16">
      ...
      <div>
        <Input ref={title} type="text" label="Title" isTextArea={false}></Input>
        <Input ref={description} label="Description" isTextArea={true}></Input>
        <Input ref={due_date} type="date" label="Due Date" isTextArea={false}></Input>
      </div>
    </div>
    </>
  );
